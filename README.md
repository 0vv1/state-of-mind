...
Die Themen der akustischen Beschallung sowie der NLPs bilden ein weites
Spektrum ab:
...
bewohnten Wohnungen aufzunehmen, in deren Hintergrund ich (sehr leise)
die relevanten Stimmen/<wbr>Geräusche "halluziniere".  
Eine Auswahl wird hier (in der Hoffnung darauf, dass irgendjemand&trade;
...
Tonspuren), Hypnose, Trance, Suggestion, Desinformation, nebeneinander
bestehende alternative Realitäten, Manipulation von Emotionen durch
Auslösen von Furcht/Panik, Zweifeln & Ungewissheit, emotionale
Bindung/<wbr>Lösung, Gaslighting, In-Frage-Stellen des Erlebten,
Manipulation von Lautstärke und Intonation der eingesetzten Stimmen,
Nutzen oder Imitieren von Stimmen real existierender Personen ohne
(oder mit verändertem) Kontext, meistens ohne (oder falschem) zeitlichen
